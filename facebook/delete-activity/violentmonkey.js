...
(function() {
  ...
  const activityCats = {
    ...
    "LOGGEDINFORMATIONSEARCHSCHEMA": {"type":"2","menu":"Action options","buttons": [{"text":"Delete","confirm":"Delete"}]},
    "LOGINSLOGOUTS": {"type": "TODO"},
    "MANAGEPOSTSPHOTOSANDVIDEOS": {"type":"1","text":"Trash","confirm":"Move to trash"},
    "MANAGETAGSBYOTHERSCLUSTER": {"type":"1","text":"Remove Tags","confirm":"Remove tags"},
    ...
    "OTHERRECORDS": {"type":"2","menu":"Action options","buttons": [{"text":"Delete","confirm":"Delete"}]},
